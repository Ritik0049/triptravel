...
const Header = () => {
  ...
  return (
    <header ref={headerRef} className=" bg-blue-950 text-white transition-all shadow-md duration-300">
      <nav className="container mx-auto px-5 flex justify-between items-center py-2">
        ...
        {isMenuOpen && (
          <div className="md:hidden text-black fixed text-center top-0 h-screen right-0 w-2/3 bg-gray-100 duration-300 p-4 shadow-md z-40">
            <IoClose
