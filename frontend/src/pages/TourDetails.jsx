        ...
        <div>
          <div className="flex flex-col md:flex-row gap-6">
            <div className="flex-shrink-0">
              <div className="max-w-2xl max-h-[300px]  rounded-md overflow-hidden">
                <img src={photo} alt={title} />
              </div>
              <div className="h-auto max-w-5xl my-8 overflow-hidden border-solid border-[2px] shadow-sm border-gray-200 rounded-md space-y-4 px-2 py-2 md:px-8 md:py-8 mx-auto">
